...
INSERT INTO student_query(StudentID, FirstName, MiddleName, LastName, 
Gender, Age, DateOfBirth, Section)
VALUES ('A119A0781','Rodolfo ', 'A.', 'Cuario', 'Male', 31, 'December 26, 1990' , 'RECBSITA61'),
...
('A119A0036','Rustom ', 'S.', 'Nuñez ', 'Male', 21 , 'July 13, 2000', 'CU2BSITA61');



INSERT INTO student_query(StudentID, FirstName, MiddleName, LastName, 
Gender, Age, DateOfBirth, Section)
VALUES ('A119G0355','Patrick', 'Garay', 'Lindio', 'Male', 22, 'May 9, 1999 ', 'BSITA61'),
...
('A119G0036','Kenneth Vincent', 'Pocot', 'Hugo', 'Male', 21 , 'December 23, 2000', 'CAMBSITA61'),
...
INSERT INTO student_query  (StudentID, FirstName, MiddleName, LastName, 
Gender, Age, DateOfBirth, Section)
VALUES ('A119G0007','Reynand John', 'Peralta', 'Rovira', 'Male', 24, 'June 18 1994 ', 'CAMBSITA61'),
...
('A119G0318','Vince', 'Mendoza ', 'Donasco', 'Male', 21 , 'April 03, 2001', 'CAMBISTA61');
